...
with open(filename, 'w') as csvfile: 
    ...
    for i in range(1000):
        ...
        rown = [[str(random.choice(gender)),str(random.choice(gender)) , age, random.choice(["YES", "NO"]), random.choice(["YES", "NO"]), random.choice(["YES", "NO"]), random.choice(["YES", "NO"]),type_of_matterial_prefarred , type_of_school, yes_no]]
